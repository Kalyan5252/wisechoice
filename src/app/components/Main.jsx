      ...
      {isLoading ? (
        ...
        <div className="p-8 h-full w-full flex flex-col gap-4 ">
          ...
          <div className="grid grid-cols-3 gap-4">
            <GaugeMeter label="Overall Score" value={100} />
            <GaugeMeter label="Goodness Score" value={33} />
            <GaugeMeter label="Fairness Score" value={90} />
          </div>
          {/* </div> */}
        </div>
      )}
